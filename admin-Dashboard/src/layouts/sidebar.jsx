    ...
    <aside
        ...
        >
            <div className="flex gap-x-3 p-3">
                ...
                />
                {!collapsed && <p className="text-lg font-medium text-slate-900 transition-colors dark:text-slate-50">Cyber Secure</p>}
         
            </div>
            <div className="flex w-full flex-col gap-y-4 overflow-y-auto overflow-x-hidden p-3 [scrollbar-width:_thin]">
            {navbarLinks
                  .filter((group) => group.title !== "Logout") 
                  .map((navbarLink) => (
                    <nav
